document.addEventListener('DOMContentLoaded', () => {
    ...
    async function registerBiometric() {
        try {
            // Note: In a real app, challenge comes from server. 
            // Localhost/HTTPS required.
            ...
            const publicKey = {
                challenge: challenge,
                rp: { name: "PayTrack App" },
                user: {
                    id: idBuffer,
                    name: userId,
                    displayName: "PayTrack User"
                },
            ...
            console.error(err);
            showNotification('Biometric setup failed. Ensure your device supports it.', 'error');
            return false;
        }
    }
